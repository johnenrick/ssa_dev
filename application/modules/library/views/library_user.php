                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-inline">
                                                <input class="form-control" id="materialAccessControlPeriodNumber" type="number" placeholder="Period" name="periodNumber" >
                                                <select class="form-control"  id="materialAccessControlPeriodUnit" name="periodUnit" >
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control"  id="materialAccessControlFineRate" type="number" step="0.01" placeholder="Fine Rate" name="fineRate" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
...
<div class="row" >
    ...
    <div class="col-md-12">
        <table class="table table-hover">
            <thead>
                <tr>
                    <th class="materialAccessControlListSorter" sorter_name="accession_number" sort="0" style="width:15%">Description
                    ...
                    <th class="materialAccessControlListSorter" sorter_name="call_number" sort="0" style="width:15%">Period
                        <span class="glyphicon glyphicon-triangle-bottom sortDown" aria-hidden="true" style="display:none"></span>
                        <span class="glyphicon glyphicon-triangle-top sortUp" aria-hidden="true" style="display:none"></span>
                    </th>
            ...
            <tfoot>
                <tr>
                    ...
                    <td style="text-align:center;" >
                        <button class="btn" id="materialAccessControlListPreviousPage">Previous</button>
                        <button id="materialAccessControlListNextPage" class="btn">Next</button>
                    </td>
                    <td style="text-align:right">
                        Page <span id="materialAccessControlListCurrentPage">1</span>
                        of <span id="materialAccessControlListTotalPage">1</span>
                    </td>
                </tr>
            </tfoot>
        </table>
