                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="">
                                               <!--
                                                ...
                                                -->
                                                <select class="form-control"  id="catalogingTypeOfMaterial" placeholder="Material" name="typeOfMaterial" required="">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                        ...
                                        <div class="form-group ">
                                            <label for="school_year">Cost Price</label>
                                            <div class="input-group">
                                                <span class="input-group-addon" id="addon-php">₱</span>
                                                <input type="text" class="form-control" id="catalogingCostPrice" type="text" placeholder="0.00" name="costPrice" aria-describedby="addon-php">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
...
<div class="col-md-10 col-md-offset-1">
    ...
    <button class="btn btn-success pull-right" id="catalogingCreateFormButton" type="button" style="margin-right:10px">Create</button>
</div>
<!--###### Student Listing--->
<div class="row" >
    <!--##### New Student ####--->
    ...
    <div class="col-md-12">
            ...
            <thead>
                <tr>
                   <!--
                    ...
                    -->
                    <th colspan="2">
                        <button id="btn-export-data" data-loading-text="Exporting..." class="btn btn-warning">
                ...
                <tr>
                    ...
                    <th class="catalogingListSorter" sorter_name="title" sort="0">Title
                        <span class="glyphicon glyphicon-triangle-bottom sortDown" aria-hidden="true" style="display:none"></span>
                        <span class="glyphicon glyphicon-triangle-top sortUp" aria-hidden="true" style="display:none"></span>
                    </th>
        ...
        <div class="prototype" style="display:none;">
            <table>
                <tr class="catalogingListRow" assessment_type_id="0">
                    ...
                    <td class="catalogingListTitle" width="35%"></td>
        ...
        <div class="exportdummy" style="display:none;">
        </div>
    </div>
</div>
