...
$(document).ready(function(){
    ...
    $("#clubManagementSchoolYearFilter").val((new Date("1,1,"+currentDate.getFullYear()).getTime())/1000);
...
clubManagement.refreshOptions = function(){
    ...
    for(var x = 1990; x <= 2040; x++){
        $("#clubManagementSchoolYearFilter").append("<option value='"+(new Date("1,1,"+x).getTime())/1000+"' >"+x+"</option>");
    }
    //courses
    setTimeout(function(){
