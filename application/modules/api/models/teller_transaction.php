...
<div class="row">
    ...
    <div class="col-md-6 ">
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                    <input id="tellerTransactionOrderReceiptNumber" class=" form-control " type="text" placeholder="Order Receipt Number" name="" style="text-align:right;color:red">
                </div>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label>Remarks</label>
            <br>
            <textarea class="form-control" style="resize:vertical" id="tellerTransactionRemarks">
...
<div class="row" >
    ...
    <div class="col-md-12">
        <table class="table table-hover">
            ...
            <tbody id="tellerTransactionParticularListBody">
...
<div id="tellerTransactionReceiptDiv" style="display:none">
    ...
    <div id="tellerTransactionReceipt" style="">
        <div id="tellerTransactionReceiptPayee" style="">John Enrick Plenos<br>Section ng mga gwapo</div>
        <div id="tellerTransactionReceiptDate" style="">11/12/2015</div>
        <div id="tellerTransactionReceiptParticularLabel" style=""></div>
        <div style="display: inline-flex;">
            <div id="tellerTransactionReceiptParticularDescription" style="">Tubig</div>
            <div id="tellerTransactionReceiptParticularAmount" style="">100.00</div>
        </div>
        <div style="display: inline-flex;">
            <div id="tellerTransactionReceiptParticularDescriptionFooter" style="">asd</div>
            <div id="tellerTransactionReceiptParticularTotalAmount" style="">100.00</div>
        </div>
        <div id="tellerTransactionReceiptParticularCashier" style="">Maam Nelyn</div>
    </div>
</div>