...
assessmentItemReport.paymentList = function(toPrint){
    ...
    dataFilter.academic_year = systemUtility.getCurrentAcademicYear();
    //sorting
    ...
    $.post(systemApplication.url.apiUrl+"c_circulation/retrieveLibraryPortalList", dataFilter, function(data){
        ...
        if(!response["error"].length){
            for(var x = 0; x < response["data"].length; x++){
                ...
                response["data"][x]["description"] = response["data"][x]["description"].toLowerCase();
